...
const ListItem = /*#__PURE__*/forwardRef((props, ref) => {
  ...
  return (
    ...
    React.createElement("li", {
      ...rest,
      ref: ref,
      className: clsx(styles['mtsds-bulleted-list__item'], className)
    }, title && /*#__PURE__*/React.createElement("div", {
      role: "heading",
      "aria-level": ariaLevel,
      className: styles['mtsds-bulleted-list__item-title']
    }, title), subTitle && /*#__PURE__*/React.createElement("div", {
      className: styles['mtsds-bulleted-list__item-subtitle']
    }, subTitle), isText && /*#__PURE__*/React.createElement("div", {
      role: "heading",
      "aria-level": ariaLevel,
      className: styles['mtsds-bulleted-list__item-text']
